<body>
  <!-- Sidenav -->
  <nav class="sidenav navbar navbar-vertical  fixed-left  navbar-expand-xs navbar-light bg-grayy" id="sidenav-main">
    <div class="scrollbar-inner">
      <!-- Brand -->
      <div class="sidenav-header  align-items-center" >
        <a  href="#">
				<img src="<?php echo base_url(); ?>assets/img/nayeli.png" alt="Image placeholder" width="230" height="90" style="margin-top: 25px;" >
        </a>
      </div>
      <div class="navbar-inner">
        <!-- Collapse -->
        <div class="collapse navbar-collapse" id="sidenav-collapse-main" style="margin-top: 40px;">
          <!-- Nav items -->
          <ul class="navbar-nav">
            <!-- <li class="nav-item">
